...
import './Search.css'
import ListSongs from '../../../components/organism/listSong/ListSongs'
            ...
            <form onSubmit={submitBusqueda}>
                <div className="container-input-search">
                    <div className="input-search">
                        <img  className="search-icon" alt="Search icon" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Search_Icon.svg/1024px-Search_Icon.svg.png" value="" ></img>
                        <input
                             className="input" 
                             type="text" 
                             name="name" 
